...
export default function Home() {
  return (
    <div>
      ...
      {/* 문제-해결책 섹션 */}
      <section className="pt-16 sm:pt-20 lg:pt-24 pb-40 sm:pb-52 mb-20 sm:mb-32 bg-gradient-to-b from-white via-pink-50/30 to-white relative overflow-x-hidden">
        {/* 하단 화살표 그라데이션 디자인 */}
